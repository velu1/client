        ...
        <div className="px-6 py-2">
          ...
          <div>
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 mb-4">
                <button
                  className="bg-[#676e6e] text-white cursor-pointer text-sm font-semibold px-6 py-2 rounded"
              ...
              <form
                ...
                className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-7 border border-primary rounded-md md:border-none p-8 md:p-0"
              >
                {editingId && (
                ...
                <TextField
                  ...
                  size="small"
                  fullWidth
                  error={!!errors.internalPartNo}
                  helperText={errors.internalPartNo}
                  required
                  inputProps={{ maxLength: 200 }}
                />
                <TextField
