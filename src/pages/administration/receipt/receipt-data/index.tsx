          ...
          <div>
            <div className="flex flex-col gap-6">
              ...
              <form
                ...
                className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4 rounded-xl border border-gray-100 bg-white p-5 shadow-sm"
              >
                {editingId && (
                  <div className="col-span-1 md:col-span-3 xl:col-span-4">
                    <h2 className="text-sm font-semibold text-[#434a52]">Edit Receipt Data</h2>
                  </div>
                )}
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-medium text-gray-500">Receipt Number <span className="text-red-400">*</span></label>
                  <input name="receiptNumber" value={formData.receiptNumber} onChange={handleChange}
                    className={`w-full px-3 py-2 text-sm border rounded-lg bg-white text-gray-800 outline-none transition-all ${errors.receiptNumber ? "border-red-400 focus:ring-2 focus:ring-red-200" : "border-gray-200 focus:border-[#434a52] focus:ring-2 focus:ring-[#434a52]/10"}`} />
                  {errors.receiptNumber && <p className="text-xs text-red-400">{errors.receiptNumber}</p>}
                </div>
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-medium text-gray-500">Receipt Quantity <span className="text-red-400">*</span></label>
                  <input name="receiptQuantity" type="number" min="1" value={formData.receiptQuantity} onChange={handleChange}
                    className={`w-full px-3 py-2 text-sm border rounded-lg bg-white text-gray-800 outline-none transition-all ${errors.inwardQty ? "border-red-400 focus:ring-2 focus:ring-red-200" : "border-gray-200 focus:border-[#434a52] focus:ring-2 focus:ring-[#434a52]/10"}`} />
                  {errors.inwardQty && <p className="text-xs text-red-400">{errors.inwardQty}</p>}
                </div>
                <div className="flex flex-col gap-1">
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-xs font-medium text-gray-500">Date Of Receipt</label>
                  <input name="dateOfReceipt" type="date" value={formData.dateOfReceipt} onChange={handleChange}
