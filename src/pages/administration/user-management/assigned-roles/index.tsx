      ...
      {showDialog && (
        <DialogComponent
          ...
          buttons={
            <>
              <button
                className="px-5 py-1.5 text-sm font-medium border border-gray-200 text-gray-600 rounded-lg hover:bg-gray-50 transition-colors cursor-pointer"
                onClick={() => setShowDialog(false)}
              >
                No
              </button>
              <button
                className="px-5 py-1.5 text-sm font-medium bg-[#434a52] text-white rounded-lg hover:bg-[#676e6e] transition-colors cursor-pointer"
