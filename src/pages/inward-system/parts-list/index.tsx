        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Select a row to edit, reprint, return or scrap
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-medium px-3.5 py-2 rounded-lg border transition-all
                disabled:opacity-40 disabled:cursor-not-allowed
                enabled:border-[#434a52] enabled:text-[#434a52] enabled:hover:bg-[#434a52] enabled:hover:text-white"
            >
              Edit
            </button>
            <button
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 text-xs font-medium px-3.5 py-2 rounded-lg border transition-all
                disabled:opacity-40 disabled:cursor-not-allowed
                enabled:border-red-300 enabled:text-red-600 enabled:hover:bg-red-50"
            >
              Scrap
            </button>
          </div>
