...
const SummaryTable: React.FC<SummaryTableProps> = ({ printerConfig }) => {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start md:items-center mb-4">
        <h2 className="hidden md:block text-xl font-medium">Summary</h2>
