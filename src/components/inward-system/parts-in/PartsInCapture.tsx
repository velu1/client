    ...
    <div className="bg-white rounded-md shadow-sm border">
      ...
      {dialogMode === "dataConfirmation" && captureResponse && (
        <DataConfirmationDialog
          ...
          capturedImageUrl={capturedImageDataUrl} // Pass the locally captured image as fallback
        />
      )}
      ...
      <div className="flex items-center justify-between px-4 py-2 ">
        ...
        >
          <svg
            className={`w-4 h-4 md:w-5 md:h-5 text-[#676e6e] transition-transform duration-300 ${
      ...
      <div
        className={`transition-all duration-300 overflow-hidden ${
          collapsed
            ? "max-h-0 opacity-0"
            : "max-h-[1000px] opacity-100 px-4 py-4"
        }`}
      >
        <div className="space-y-4">
            ...
            {invoiceMode ? (
              ...
              <TextField
                ...
                onChange={(e) => {
                  ...
                  setReceiptNumber(filteredValue);
                }}
          ...
          {/* Image Placeholder with Icon  where camera will open inside this*/}
          <div>
            <CameraCapture
              onCapture={handleCapture}
              disabled={false} // Always allow reset
